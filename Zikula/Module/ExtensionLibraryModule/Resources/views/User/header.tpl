<div class="row">
        ...
        <div class="pull-right">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a href="{modurl modname=$module type='user' func='filter' filterType="extensionType" filter="all" returnUrl=$request->getRequestUri()|urlencode}">{gt text='All Types'}</a></li>
                    <li role="presentation"  class="divider"></li>
                    {foreach from=$extensionTypes key='id' item='text'}
                        <li><a href="{modurl modname=$module type='user' func='filter' filterType="extensionType" filter=$id returnUrl=$request->getRequestUri()|urlencode}">{$text}</a></li>
                    {/foreach}
                </ul>
            </div>
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu" id="el-core-version-filter">
                    <li><a href="{modurl modname=$module type='user' func='filter' filterType="coreVersion" filter="all" returnUrl=$request->getRequestUri()|urlencode}">{gt text='All versions'}</a></li>
                    <li role="presentation"  class="divider"></li>
                    <li role="presentation" class="dropdown-header">Current versions</li>
                    {foreach from=$coreVersions.supported key="version" item="foo"}
                        <li><a href="{modurl modname=$module type='user' func='filter' filterType="coreVersion" filter=$version returnUrl=$request->getRequestUri()|urlencode}">{$version}</a></li>
                    {/foreach}
                    <li role="presentation"  class="divider"></li>
    ...
    <hr />
    <ol class="breadcrumb">
        <li><a href="{modurl modname=$module type='user' func='index'}">{gt text='Library Home'}</a></li>
